...
class PluginConfigRepo:
    ...
    def delete_plugin_config(
        self, plugin_id: str, pipeline: str, db_name: str = None
    ) -> None:
    ...
    def update_plugin_config(
        self, plugin_id: str, pipeline: str, config: dict, db_name: str = None
    ) -> None:
        """
    ...
    def insert_plugin_config(
        ...
        self._storage.insert(
            "plugin_configs",
            {"plugin_id": plugin_id, "pipeline": pipeline, **config},
            db_name=db_name,
        )
