...
def plugin_config_view(plugin):
    ...
    if plugin == "gather_plugin":
        ...
        # Flask passes request as flask.request, FastAPI expects a compatible object
        # This works if handle_config_request accepts flask.request
        ...
        # Call the plugin's own handler (returns HTML string)
